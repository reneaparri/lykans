...
$myaccounts2=[];
array_push($myaccounts2,"jadeashley01");
array_push($myaccounts2,"joegie01");
array_push($myaccounts2,"liela0520");
array_push($myaccounts2,"radrian2005");
array_push($myaccounts2,"jashley06");
...
echo "$White";
echo "$ScriptName\n";
echo "$Green\nHi Ashley, what do you want to do?\n";
echo "$Yellow\n1. Max Rate (dummy -> main)";
echo "$Cyan\n2. Max Rate (main -> main)";
echo "$Yellow\n3. Add Moments";
echo "$Cyan\n4. Add Posts";
echo "$Yellow\n5. Check GEMS";
echo "$Cyan\n6. Harvest GEMS";
echo "$Green\n7. Exit\n$Yellow\n";
   ...
   switch($inputtask) {
      case "1" :
        ...
        case "2" :
          @system("clear");
          rateit($myaccounts2,$myaccounts2,$PhoneID,$PhoneModel);
          mainmenu();  
...
//      addPosts($vuser, $bearer, $device_id, $title_content, $xhash);
   ...
   echo "\n$Green";
   echo "Summary after add $posttype \n";
   echo "Username    | $currentUser\n";
   displaygems($bearer);
   echo "--------------------------------\n";
   sleep(2);
